...
import {
    ...
    PeopleAltOutlined,
    Settings,
    EmojiPeople, Brightness3, WbSunny,
...
function Sidebar({addedClasses, openDrawer, menuClick, prefersDarkMode, setPrefersDarkMode}) {
    ...
    const [openDeleteMyAccount, setOpenDeleteMyAccount] = React.useState(false);
        ...
        <div className={classes.root}>
            ...
            >
                ...
                <List>
                    ...
                    <ListItem button key={"MyProfile"} onClick={() => {
                    ...
                    <Collapse in={openMySettings} timeout={"auto"} unmountOnExit>
                        <List>
                            <ListItem button
                                ...
                                <ListItemText primary={"Set Layout Mode"}/>
                            </ListItem>
                            {!state.active ?
                                <ListItem button className={classes.nested}>
                                    <Skeleton width={240} height={48} animation={'wave'}/>
                                ...
                                openDrawer ?
                                    ((state.globalRole === AdminRole) ?
                                        ...
                                        <List>
                                            ...
                                            <DeleteMyAccountDialog setOpenDialog={setOpenDeleteMyAccount}
                                                                   openDialog={openDeleteMyAccount}/>
                                        </List>) : null
                            }
                        </List>
                    </Collapse>
